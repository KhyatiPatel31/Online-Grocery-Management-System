                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/Res_img/logo.png" height="70px" width="70px" alt="Shop logo">'; ?></figure>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
										...
										<form method="post" action='items.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><img src="admin\Res_img\items\<?php echo $product['img'];?>" alt=""></a>
                                            </div>
                                            <!-- end:Logo -->
